...
var headers = {
	...
	/*'Accept-Encoding': 'gzip, deflate, sdch', 傻逼的网站对图片进行了gzip，浏览器可以ungzip，但这个nodejs发的请求不能ungzip*/
...
var ws = fs.createWriteStream('11111.jpg');
ws.on('finish', function(){
	console.log('downloaded');
});

var imgsrc = 'http://gsxt.zjaic.gov.cn/images/gs/logo-top.jpg';
